...
falconn_swig: $(ALL_HEADERS) $(PYTHON_DIR)/falconn.i
	mkdir -p $(PYTHON_OUT_DIR)
	$(SWIG) -c++ -python -builtin -outdir $(PYTHON_OUT_DIR) -o $(PYTHON_OUT_DIR)/falconn_wrap.cc $(PYTHON_DIR)/falconn.i
	mkdir -p obj
